                        ...
                        {!generatedI2VUrl ? (
                            <>
                                <div className="space-y-4">
                                    ...
                                    {/* Camera Styles Quick Insert */}
                                    <div className="space-y-2">
                                        <label className="text-[10px] text-white/40 uppercase tracking-widest block">Camera Style (Click to Append)</label>
                                        <div className="flex flex-wrap gap-2">
                                            {[
                                                { label: "Handheld Vlog", value: "(Shot on smartphone, front-facing camera, handheld selfie vlog style, slight natural shake) " },
                                                { label: "Static Tripod", value: "(Static camera on tripod, stable frame, eye-level, documentary style) " },
                                                { label: "Walk & Talk", value: "(Dynamic follow shot, subject walking towards camera, stabilized handheld) " },
                                                { label: "Cinematic Pan", value: "(Smooth cinematic pan shot, shallow depth of field, 35mm lens) " }
                                            ].map(style => (
                                                <button
                                                    key={style.label}
                                                    onClick={() => {
                                                    ...
                                                    className="px-2 py-1 bg-white/5 hover:bg-emerald-500/20 text-emerald-400 border border-white/10 hover:border-emerald-500/30 rounded text-[10px] uppercase font-bold tracking-wider transition-colors"
                                                >
                                                    {style.label}
                                                </button>
                                            ))}
                                            <button
                                                ...
                                                className="px-2 py-1 bg-white/5 hover:bg-red-500/20 text-red-400 border border-white/10 hover:border-red-500/30 rounded text-[10px] uppercase font-bold tracking-wider transition-colors ml-auto"
                                            >
                                                Clear
                                            </button>
                                        </div>
