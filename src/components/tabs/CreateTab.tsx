                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6 flex-1 flex flex-col gap-6">
                        <div className="flex items-center justify-between pb-4 border-b border-white/5">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-bold text-white uppercase tracking-widest">Influencer Script & Concept Creator</h2>
                            </div>
                            <button
                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="flex justify-between items-center mb-1">
                                    <label className="text-xs text-white/50 block">Video Topic / Hook Idea</label>
                                ...
                                {visualsImage ? (
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Enter a specific topic, history fact, or review item..."
                                    ...
                                    <input
                                        ...
                                        value={specificVisuals}
                                        onChange={(e) => setSpecificVisuals(e.target.value)}
                                        placeholder={(currentTheme as any).defaultSetting || (currentTheme as any).defaultOutfit || "Enter topic..."}
                ...
                <div className="flex flex-col h-full space-y-6">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6 flex-1 flex flex-col">
                        <div className="flex justify-between items-center mb-4 pb-4 border-b border-white/5">
                            <h2 className="text-sm font-bold text-white uppercase tracking-widest">Script Strategy</h2>
                            <button
